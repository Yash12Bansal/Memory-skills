...
public class uq3 extends JFrame implements ActionListener,MouseListener,MouseMotionListener,KeyListener
{
...
c.add(ls);
        ...
        for(int i=0;i<64;i++)
        {
            ...
            if(i%8!=0 && i!=0)
            {
               // System.out.println(y);
                l[i]=new JLabel();
                l[i].setBorder(BorderFactory.createLineBorder(Color.MAGENTA, 3));
...
//System.out.println(k+"     "+i);    
        ...
        {        
            ...
            ImageIcon iz=new ImageIcon(new ImageIcon(kkr+".jpg").getImage().getScaledInstance(78, 78,Image.SCALE_SMOOTH));
...
for(int qq=0;qq<64;qq++)
  ...
  */      
  ...
  /*      
    ...
    */    
       ImageIcon I=new ImageIcon(new ImageIcon("101.jpg").getImage().getScaledInstance(78, 78,Image.SCALE_SMOOTH));
