...
public class uq4 extends JFrame implements ActionListener,MouseListener,MouseMotionListener,KeyListener
{
  ...
  for(int nm=0;nm<64;nm++)
    ...
    if(ae.getSource()==b[nm])
    {
        ...
        if(xx%2==0)
        {
         ...
         if(selected1-selected2==1 || selected2-selected1==1)
         {
             b[nm].setEnabled(false);
            ...
            b[zc].setEnabled(true);
             ...
             xx=870+((cop%8)*45);
               ...
               int temp_y=90;
                 ...
                 t = new Timer(2200,new ActionListener() {
...
c.add(ls);
        ...
        for(int i=0;i<64;i++)
        {
            ...
            if(i%8!=0 && i!=0)
            {
               // System.out.println(y);
                l[i]=new JLabel();
                l[i].setBorder(BorderFactory.createLineBorder(Color.RED, 3));
...
//System.out.println(k+"     "+i);    
        ...
        {        
            ...
            ImageIcon i=new ImageIcon(new ImageIcon(kk+".jfif").getImage().getScaledInstance(78, 78,Image.SCALE_SMOOTH));
            ImageIcon iz=new ImageIcon(new ImageIcon(kkr+".jfif").getImage().getScaledInstance(78, 78,Image.SCALE_SMOOTH));
...
for(int qq=0;qq<64;qq++)
  ...
  */      
  ...
  /*      
    ...
    */    
       ImageIcon I=new ImageIcon(new ImageIcon("101.jfif").getImage().getScaledInstance(78, 78,Image.SCALE_SMOOTH));
...
this.requestFocusInWindow();
  ...
  {
      b[jk].removeActionListener(this);
  }
