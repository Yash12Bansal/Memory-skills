...
public class uq2 extends JFrame implements ActionListener,MouseListener,MouseMotionListener,KeyListener
{
  ...
  for(int nm=0;nm<64;nm++)
    ...
    if(ae.getSource()==b[nm])
    {
        ...
        if(xx%2==0)
        {
            ...
            xx+=45;
            System.out.println("qq"+selected1);
         ...
         selected2=Integer.parseInt(l[nm].getText());
                     System.out.println("www"+selected2);
    ...
    //                b[hh].setBackground(Color.BLACK);
        ...
        for(int i=0;i<64;i++)
        {
            ...
            if(i%8!=0 && i!=0)
            {
               // System.out.println(y);
                l[i]=new JLabel();
                l[i].setBorder(BorderFactory.createLineBorder(Color.BLUE, 3));
...
for(int qq=0;qq<64;qq++)
  ...
  */      
  ...
  /*      
    ...
    */    
       ImageIcon I=new ImageIcon(new ImageIcon("1.jfif").getImage().getScaledInstance(78, 78,Image.SCALE_SMOOTH));
